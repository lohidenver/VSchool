...
function listData(data) {
    ...
    // document.getElementById("todo-list").innerHTML = ""; //erases old data before inserting the updated version
...
///////////////This clears the old data before inserting the new version
function clearList() {
